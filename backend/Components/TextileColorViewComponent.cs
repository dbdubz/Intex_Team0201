...
{
    public class TextileColorViewComponent : ViewComponent
    {
        ...
        public TextileColorViewComponent(mummyContext data, RoleManager<IdentityRole> roleManager) //Bring in the _mummyContext.
        {
            _mummyContext = data;
